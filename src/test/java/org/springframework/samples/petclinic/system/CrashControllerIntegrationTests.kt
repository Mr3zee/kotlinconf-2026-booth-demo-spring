...
internal class CrashControllerIntegrationTests {
    ...
    fun triggerExceptionJson() {
        ...
        assertThat(resp.body).containsEntry(
            "message",
    ...
    fun triggerExceptionHtml() {
        ...
        // html:
        assertThat(resp.body).containsSubsequence(
        ...
        assertThat(resp.body).doesNotContain(
